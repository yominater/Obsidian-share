...
- `locale`: used for [i18n](features/i18n.md) and date formatting
...
- `theme`: configure how the site looks.
  ...
  - `colors`: controls the theming of the site.
    ...
    - `secondary`: link colour, current [graph](features/graph%20view.md) node
    - `tertiary`: hover states and visited [graph](features/graph%20view.md) nodes
    - `highlight`: internal link background, highlighted text, [highlighted lines of code](features/syntax%20highlighting.md)
...
![quartz transform pipeline](images/quartz%20transform%20pipeline.png)
...
You should take care to add the plugin to the right entry corresponding to its plugin type. For example, to add the [ExplicitPublish](plugins/ExplicitPublish.md) plugin (a [Filter](tags/plugin/filter)), you would add the following line:
...
If you'd like to make your own plugins, see the [making custom plugins](advanced/making%20plugins.md) guide.
