...
![800](images/quartz%20layout.png)
...
See [a list of all the components](component.md) for all available components along with their configuration options. You can also checkout the guide on [creating components](advanced/creating%20components.md) if you're interested in further customizing the behaviour of Quartz.
