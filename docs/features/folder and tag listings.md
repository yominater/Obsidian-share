...
Quartz allows you to define a custom sort ordering for content on both page types. The folder listings are a functionality of the [FolderPage](../plugins/FolderPage.md) plugin, the tag listings of the [TagPage](../plugins/TagPage.md) plugin. See the plugin pages for customization options.
