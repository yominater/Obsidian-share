...
> [!warning]
> Wondering why Mermaid diagrams may not be showing up even if you have them enabled? You may need to reorder your plugins so that [ObsidianFlavoredMarkdown](../plugins/ObsidianFlavoredMarkdown.md) is _after_ [SyntaxHighlighting](../plugins/SyntaxHighlighting.md).
